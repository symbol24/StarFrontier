...
public class EAIBehaviorFirstBoss : EAIBehaviors {
	...
	private int m_ThreeQuartersUsedID = 0;
	...
	private int m_OneQuarterUsedID = 1;
	...
	public override void UpdateBehavior() {
		...
		case BossState.half:
			...
			ShootFromTheseCannons(1, m_CannonList1, m_Bullets[m_HalfUsedID], m_HalfShotDelay, m_HalfGroupingDelay, m_HalfNumberOfGroupedShots);
			ShootFromTheseCannons(2, m_CannonList2, m_Bullets[m_ThreeQuartersUsedID], m_ThreeQuartersShotDelay, m_ThreeQuartersGroupingDelay, m_ThreeQaurtersNumberOfGroupedShots);
